<template>
  <div class="flex-1 max-h-fit">
    <div class="font-sans antialiased bg-orange-300" id="app">
      <nav class="flex items-center justify-between flex-wrap bg-teal p-6">
        ...
        <div class="block sm:hidden text-xl">
          <button
        ...
        <button
          @click="handleLogOut"
          class="no-underline inline-block text-sm px-4 py-2 leading-none border rounded text-white border-white hover:border-transparent hover:text-teal hover:bg-orange-400 mt-4 sm:mt-0"
        >
          Log out
        </button>
      </nav>
